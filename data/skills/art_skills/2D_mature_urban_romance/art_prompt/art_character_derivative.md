...
| 段落 | 写什么 |
|---|---|
| 第一段 · 身份锁定与新服化 | 固定以「以参考图1中人物为唯一脸部身份母版，保持骨相五官、发际线、肤色与体型不变，只替换服化妆造：」开头；然后按 L1→L6 写：妆容（先按第三节 S1–S4 决策档位与风格）、发型与发饰、内搭、主服（写到下装）、配饰、鞋履（款式、材质、颜色）；写清颜色与材质，并按角色身份与场景差异化搭配 |
| 第二段 · 脸部身份复述 | 用 2–4 句复述父级描述里的关键脸部特征（脸型、眼型与瞳色高光、眉、鼻唇、肤色、身高与头身比），强调与参考图1完全一致 |
| 第三段 · 表情 | 主大头照的表情：贴合角色当下处境与性格的一种具体、克制的情绪，写清眉眼嘴的状态；结尾固定写：「主大头照与全身视图均为同一人物、同一发型服装、同一时间状态。」 |
| 第四段 · 画风质感与色彩光线 | 二次元动画风格、赛璐璐上色、现代都市风格、强对比度、极致细节、衣服质感清晰、纹理超清晰；按场合给低饱和都市主色调；均匀柔光、无硬阴影 |
...
```
以参考图1中人物为唯一脸部身份母版，保持骨相五官、发际线、肤色与体型不变，只替换服化妆造：出席慈善晚宴的男性伪素颜基础妆，肤色干净清透、眉形自然英挺、唇色保留自然血色；纯黑短发改为利落的侧分背头，露出完整额头，发丝层次分明；白色礼服衬衫配黑色丝质领结，外穿黑色戗驳领单排扣礼服西装，缎面驳领带柔和光泽，同色直筒礼服西裤；左腕一只银色细表带腕表，袖口一对黑玛瑙袖扣，黑色细腰带；黑色漆皮牛津鞋，鞋面干净挺括；羊毛礼服面料与缎面驳领质感清晰。

脸部与参考图1完全一致：偏窄长脸、下颌线利落、下巴略方，狭长凤眼、深灰瞳色带细长冷白高光，浓黑平直眉，挺直鼻梁与分明薄唇，白皙透亮的肤色，身高约 183cm、八头身比例。

主大头照选择他步入晚宴时克制又带锋芒的神情：正面平视，目光沉静笃定，唇线平直微收。主大头照与全身视图均为同一人物、同一发型服装、同一时间状态。

二次元动画风格，赛璐璐上色，现代都市风格，强对比度，极致细节，衣服质感清晰、纹理超清晰，缎面驳领与漆皮鞋面的高光以赛璐璐块面表现；黑、白与银灰为主的冷调都市配色，均匀柔光、无硬阴影。
```
...
| X6 | 在人物衍生资产中加入场景描述（现代室内/室外/天气等环境元素） |
| X7 | 省略鞋履设计，导致脚部只有默认底模或无明确搭配 |
| X8 | 所有角色使用同款同色同版型服装，缺乏角色差异 |
| X9 | 输出「核心要素速查」「分层构建方案」「视觉约束」「禁止事项」「衍生方案」等章节 |
| X10 | 加入任何道具交互（手持手机/书本/雨伞/咖啡杯等物品） |
| X11 | 改变底模姿态（行走/回眸/举手/侧身/奔跑/低头/仰望等动作描述） |
| X12 | 加入表情与姿态联动描述（如「侧身45°行走嘴角浅弯」等叙事性描写） |
| X13 | 未分析用户线索就直接套用固定妆容 |
| X14 | 错误保持素颜，导致衍生资产缺少应有妆造 |
| X15 | 仅因道具/场景/动作词而误把妆容升级，导致妆造强度决策错误 |
