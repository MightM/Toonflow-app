...
| 从基准状态衍生 | 保持不变 | 变化项 |
|---|---|---|
| 整洁 → 欢好后 | 空间结构、家具 | 凌乱床褥、落红的床单、褪下散落的衣物与肚兜、倒下的烛台、胭脂盒打翻 |
| 整洁 → 劫后 / 打斗后 | 空间结构 | 翻倒的桌案、碎瓷、血迹溅在墙上与地上、断剑、散落的箱笼 |
| 整洁 → 囚禁 / 刑讯后 | 空间结构 | 铁链、稻草、血迹、火盆余烬、撕碎的衣物 |
| 平日 → 大婚 / 夜宴 | 空间结构 | 红绸、红烛、灯笼、酒案、乐器 |
| 平日 → 战后 | 地形 | 断旗、尸体、血染泥土、烧焦的营帐、乌鸦 |
